...
TaskTab::TaskTab(QWidget *parent) : QWidget(parent)
{
    ...
    zygoteGridWidget = new GridWidget(this, 370, palette);
    zygoteGridWidget->setGeometry(175, 40, 370, 370);
    QLabel *patternHeaderLabel = new QLabel(tr("Hledany vzor:"), this);
    patternHeaderLabel->setFont(QFont("Helvetica", 12, QFont::Bold));
    patternHeaderLabel->move(560, 10);
    patternGridWidget = new GridWidget(this, 370, palette);
    patternGridWidget->setGeometry(560, 40, 370, 370);
...
bool TaskTab::SaveTask(std::string outputFile)
{
    ...
    fileReport = "*** CELULARNI AUTOMAT V DYNAMICKEM PROSTREDI - ULOHA ***\r\n\r\n";
